...
public class BOParticles {
    ...
    public static final RegistryObject<SimpleParticleType> MOLD_SPORE = REGISTER.register("mold_spore", () -> new SimpleParticleType(false));
    public static final RegistryObject<SimpleParticleType> TERMOSTONE_DUST = REGISTER.register("termite_dust", () -> new SimpleParticleType(false));
