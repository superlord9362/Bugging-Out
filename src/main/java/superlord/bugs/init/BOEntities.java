...
public class BOEntities {
	...
	public static final RegistryObject<EntityType<TermiteKing>> TERMITE_KING = REGISTER.register("termite_king", () -> EntityType.Builder.<TermiteKing>of(TermiteKing::new, MobCategory.CREATURE).sized(1F, 1F).build(new ResourceLocation(BuggingOut.MOD_ID, "termite_king").toString()));
	public static final RegistryObject<EntityType<TermiteQueen>> TERMITE_QUEEN = REGISTER.register("termite_queen", () -> EntityType.Builder.<TermiteQueen>of(TermiteQueen::new, MobCategory.CREATURE).sized(1F, 1F).build(new ResourceLocation(BuggingOut.MOD_ID, "termite_queen").toString()));
	...
	public static final RegistryObject<EntityType<Springtail>> SPRINGTAIL = REGISTER.register("springtail", () -> EntityType.Builder.<Springtail>of(Springtail::new, MobCategory.CREATURE).sized(0.25F, 0.25F).build(new ResourceLocation(BuggingOut.MOD_ID, "springtail").toString()));
	public static final RegistryObject<EntityType<BarkBeetle>> BARK_BEETLE = REGISTER.register("bark_beetle", () -> EntityType.Builder.<BarkBeetle>of(BarkBeetle::new, MobCategory.CREATURE).sized(1F, 1F).build(new ResourceLocation(BuggingOut.MOD_ID, "bark_beetle").toString()));
