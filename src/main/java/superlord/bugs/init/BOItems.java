...
public class BOItems {
	...
	public static final RegistryObject<Item> TERMITE_KING_SPAWN_EGG = SPAWN_EGGS.register("termite_king_spawn_egg", () -> new ForgeSpawnEggItem(BOEntities.TERMITE_KING, 0x73482A, 0x977252, new Item.Properties()));
	public static final RegistryObject<Item> TERMITE_QUEEN_SPAWN_EGG = SPAWN_EGGS.register("termite_queen_spawn_egg", () -> new ForgeSpawnEggItem(BOEntities.TERMITE_QUEEN, 0x63381A, 0x977252, new Item.Properties()));
