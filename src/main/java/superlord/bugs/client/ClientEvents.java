...
import superlord.bugs.client.entity.render.TermiteKingRenderer;
import superlord.bugs.client.entity.render.TermiteNymphRenderer;
import superlord.bugs.client.entity.render.TermiteQueenRenderer;
...
public class ClientEvents {
	...
	public static ModelLayerLocation TERMITE_KING = new ModelLayerLocation(new ResourceLocation(BuggingOut.MOD_ID, "termite_king"), "termite_king");
	public static ModelLayerLocation TERMITE_QUEEN = new ModelLayerLocation(new ResourceLocation(BuggingOut.MOD_ID, "termite_queen"), "termite_queen");
	...
	public static void registerEntityRenders(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(BOEntities.TERMITE_KING.get(), TermiteKingRenderer::new);
		event.registerEntityRenderer(BOEntities.TERMITE_QUEEN.get(), TermiteQueenRenderer::new);
	}
	...
	public static void registerLayerDefinition(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(TERMITE_KING, TermiteKingModel::createBodyLayer);
		event.registerLayerDefinition(TERMITE_QUEEN, TermiteQueenModel::createBodyLayer);
	}
