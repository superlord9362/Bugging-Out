...
public abstract class AbstractSplinterRenderer<T extends AbstractSplinter> extends EntityRenderer<T> {
	public AbstractSplinterRenderer(EntityRendererProvider.Context p_173917_) {
		super(p_173917_);
	}
