...
public class HugeTermiteMushroomFeature extends Feature<NoneFeatureConfiguration> {
	...
	private void placeMushroomTree(LevelAccessor world, RandomSource random, BlockPos pos) {
	...
	private void place6Tall3RadiusMushroomTree(LevelAccessor world, RandomSource random, BlockPos pos) {
	...
	private void place5Tall3RadiusMushroomTree(LevelAccessor world, RandomSource random, BlockPos pos) {
		int failTest = random.nextInt(2);
	...
	private void place5Tall2RadiusMushroomTree(LevelAccessor world, RandomSource random, BlockPos pos) {
		int failTest = random.nextInt(2);
	...
	private void place4Tall3RadiusMushroomTree(LevelAccessor world, RandomSource random, BlockPos pos) {
		int failTest = random.nextInt(2);
	...
	private void place4Tall2RadiusMushroomTree(LevelAccessor world, RandomSource random, BlockPos pos) {
	...
	private void place3TallMushroomTree(LevelAccessor world, RandomSource random, BlockPos pos) {
	...
	private void place2TallMushroomTree(LevelAccessor world, RandomSource random, BlockPos pos) {
