...
public class TermostoneCeilingBlobFeature extends Feature<NoneFeatureConfiguration> {
   public TermostoneCeilingBlobFeature(Codec<NoneFeatureConfiguration> p_65865_) {
      super(p_65865_);
   }
   ...
   public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> p_159861_) {
      ...
      if (!worldgenlevel.isEmptyBlock(blockpos)) {
         ...
         if (!blockstate.is(BOBlocks.TERMOSTONE.get()) && !blockstate.is(BOBlocks.POROUS_TERMOSTONE.get()) && !blockstate.is(BOBlocks.TERMITE_MUSHROOM_MYCELIUM.get())) {
            ...
            worldgenlevel.setBlock(blockpos, BOBlocks.TERMOSTONE.get().defaultBlockState(), 2);
            ...
            for(int i = 0; i < 1500; ++i) {
               ...
               if (worldgenlevel.getBlockState(blockpos1).isAir()) {
                  ...
                  for(Direction direction : Direction.values()) {
                     if (worldgenlevel.getBlockState(blockpos1.relative(direction)).is(BOBlocks.TERMOSTONE.get())) {
                        ++j;
                     }
                  ...
                  if (j == 1) {
                     worldgenlevel.setBlock(blockpos1, BOBlocks.TERMOSTONE.get().defaultBlockState(), 2);
                  }
               }
            }
