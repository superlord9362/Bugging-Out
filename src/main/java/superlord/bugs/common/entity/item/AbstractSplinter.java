...
public abstract class AbstractSplinter extends Projectile {
	@SuppressWarnings("unused")
	private static final double SPLINTER_BASE_DAMAGE = 2.0D;
	private static final EntityDataAccessor<Byte> ID_FLAGS = SynchedEntityData.defineId(AbstractSplinter.class, EntityDataSerializers.BYTE);
	private static final EntityDataAccessor<Byte> PIERCE_LEVEL = SynchedEntityData.defineId(AbstractSplinter.class, EntityDataSerializers.BYTE);
	@SuppressWarnings("unused")
	...
	public AbstractSplinter.Pickup pickup = AbstractSplinter.Pickup.DISALLOWED;
	...
	protected AbstractSplinter(EntityType<? extends AbstractSplinter> p_36721_, Level p_36722_) {
		super(p_36721_, p_36722_);
	}

	protected AbstractSplinter(EntityType<? extends AbstractSplinter> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
		this(p_36711_, p_36715_);
		this.setPos(p_36712_, p_36713_, p_36714_);
	}

	protected AbstractSplinter(EntityType<? extends AbstractSplinter> p_36717_, LivingEntity p_36718_, Level p_36719_) {
		...
		if (p_36718_ instanceof Player) {
			this.pickup = AbstractSplinter.Pickup.ALLOWED;
		}
	...
	protected void onHitEntity(EntityHitResult p_36757_) {
		...
		if (entity.hurt(damagesource, (float)i)) {
			...
			if (!this.level().isClientSide && this.getDeltaMovement().lengthSqr() < 1.0E-7D) {
				if (this.pickup == AbstractSplinter.Pickup.ALLOWED) {
	...
	public void readAdditionalSaveData(CompoundTag p_36761_) {
		...
		this.pickup = AbstractSplinter.Pickup.byOrdinal(p_36761_.getByte("pickup"));
	...
	public void setOwner(@Nullable Entity p_36770_) {
		...
		if (p_36770_ instanceof Player) {
			this.pickup = ((Player)p_36770_).getAbilities().instabuild ? AbstractSplinter.Pickup.CREATIVE_ONLY : AbstractSplinter.Pickup.ALLOWED;
		}
	...
	public static enum Pickup {
		...
		public static AbstractSplinter.Pickup byOrdinal(int p_36809_) {
